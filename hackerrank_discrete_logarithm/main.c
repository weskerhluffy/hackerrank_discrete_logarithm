//
//  main.c
//  hackerrank_discrete_logarithm
//
//  Created by ernesto alvarado on 29/08/19.
//  Copyright © 2019 ernesto alvarado. All rights reserved.
//

// XXX: https://www.hackerrank.com/contests/infinitum11/challenges/discrete-logarithm/problem
// XXX: https://cp-algorithms.com/algebra/discrete-log.html
// XXX: https://www.stopstalk.com/problems?problem_id=20703
...
COMUN_FUNC_STATICA void codechef_fibonacci_number_main(){
    ...
    scanf("%u\n",&t);
    for(natural i=0;i<t;i++){
        scanf("%u %u %u\n",&a,&b,&g);
        entero_largo r=paso_bebe_paso_gigante(a, b, g);
        printf("%lld\n",r);
    }
}
